...
export default function FarmShell() {
  ...
  return (
    <OnboardingProvider userId={currentUser?.uid}>
      <div className="app-shell">
        ...
        <div className="app-sidebar hidden md:flex w-64 bg-green-900 text-white p-6 shadow-xl flex-col">
          <Link to="/about" className="block text-2xl font-bold mb-8 hover:text-green-300 transition-colors">🌿 FanakaCo</Link>

          <ul className="space-y-2 flex-1">
            <li><NavLink to="/dashboard"   data-tour="nav-dashboard"   className={navLink}>📊 Dashboard</NavLink></li>
            <li><NavLink to="/assistant"   data-tour="nav-assistant"   className={navLink}>🤖 Assistant</NavLink></li>
            <li><NavLink to="/animals"     data-tour="nav-animals"     className={navLink}>🐄 Animals</NavLink></li>
            <li><NavLink to="/crops"       data-tour="nav-crops"       className={navLink}>🌱 Crops</NavLink></li>
            <li><NavLink to="/sales"       data-tour="nav-sales"       className={navLink}>💰 Sales</NavLink></li>
            <li><NavLink to="/marketpage"  data-tour="nav-marketplace" className={navLink}>🏪 Market</NavLink></li>
            <li><NavLink to="/reports"     data-tour="nav-reports"     className={navLink}>📈 Reports</NavLink></li>
          </ul>

          <div className="mt-4 space-y-2">
            <NavLink to="/profile" data-tour="nav-profile" className={navLink}>👤 Profile</NavLink>
            <button
        ...
        <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-green-900 text-white flex items-center justify-between px-4 py-3 shadow-lg">
          <Link to="/about" className="text-lg font-bold hover:text-green-300 transition-colors">🌿 FanakaCo</Link>
          <button
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-green-900 text-white border-t border-green-700 flex justify-around items-center py-2 shadow-lg">
          {[
            ...
            <NavLink
              key={to}
              to={to}
              data-tour={to === '/profile' ? 'nav-profile' : to === '/dashboard' ? 'nav-dashboard' : to === '/animals' ? 'nav-animals' : to === '/crops' ? 'nav-crops' : to === '/marketpage' ? 'nav-marketplace' : undefined}
              className={({ isActive }) =>
