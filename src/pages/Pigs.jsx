...
export default function Pigs() {
  ...
  const allPigs = animals.filter((a) => a.category === "pig");
    ...
    <div className="bg-green-50 min-h-screen relative p-6">
      ...
      <div className="mb-8 ml-14">
        ...
        <p className="text-green-700 font-semibold mt-1">
          Total pigs on farm: {allPigs.length}
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((cat) => {
          const pigList = allPigs.filter(
            (a) => a.type?.toLowerCase() === cat.type
          );

          const count = pigList.length;
