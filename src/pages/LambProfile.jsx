  ...
  return (
    <div className="bg-amber-50 flex flex-col">
      ...
      <div className="flex items-center gap-4 px-6 py-4 bg-white shadow-sm">
        ...
        <h2 className="text-2xl font-bold text-amber-900">Lamb Profile</h2>
          ...
          <div className="bg-white rounded-2xl shadow p-5">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                {isEditing?<input value={edited.name||""} onChange={(e)=>uf("name",e.target.value)} className="text-2xl font-bold border-b border-amber-400 outline-none w-full"/>:<h3 className="text-2xl font-bold text-amber-900">{lamb.name}</h3>}
              </div>
