...
export default function Sheep() {
  ...
  const allSheep = animals.filter(
    (a) => a.category === "sheep" && a.type && a.name
  );
        ...
        {categories.map((category) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 z-0 bg-gradient-to-br from-green-200 to-green-400 flex items-center justify-center">
