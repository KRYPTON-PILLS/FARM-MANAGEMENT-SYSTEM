...
export default function Chicken() {
  ...
  const allChickens = animals.filter((a) => a.category === "chicken");
    ...
    <div className="bg-green-50 min-h-screen relative p-6">
      ...
      <div className="mb-8 ml-14">
        ...
        <p className="text-green-700 font-semibold mt-1">
          Total chickens on farm: {allChickens.length}
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((cat) => {
          const poultryList = allChickens.filter(
            (a) => a.type?.toLowerCase() === cat.type
          );

          const count = allChickens.length;
          ...
          return (
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 z-10">
                <Link
                  to={`/animals/poultry/chicken/${cat.key}`}
