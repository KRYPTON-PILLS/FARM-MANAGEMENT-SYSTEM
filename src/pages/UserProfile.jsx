  ...
  function Input({ value, onChange, placeholder, type="text", disabled=false, className="" }) {
    return (
      <input
        ...
        disabled={disabled}
        className={`w-full border-2 ${disabled?"border-gray-100 bg-gray-50 text-gray-400 cursor-not-allowed":"border-gray-100 focus:border-green-400 bg-white"} rounded-xl px-4 py-2.5 text-sm outline-none transition ${className}`}
      />
    );
  }
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                {resetSent
                  ...
                  : <>
                      ...
                      <button onClick={handleResetPassword} disabled={resetLoading || !firebaseAvailable}
