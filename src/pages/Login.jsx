    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">FanakaCo</h1>
            ...
            {!showReset ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full border-2 border-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-green-400 transition"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-300 text-white font-semibold py-3 rounded-xl transition mt-2 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
                      <Spinner />
              ...
              <form onSubmit={handleReset} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full text-gray-500 hover:text-gray-700 text-sm font-semibold py-2 transition"
                >
                  ← Back to sign in
                </button>
              </form>
