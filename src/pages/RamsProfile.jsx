  ...
  return (
    <div className="bg-emerald-50 flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 sm:px-6 py-3 sm:py-4 bg-white shadow-sm flex-wrap">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-emerald-900">Ram Profile</h2>
          ...
          <div className="bg-white rounded-2xl shadow p-5">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                {isEditing?<input value={edited.name||""} onChange={(e)=>uf("name",e.target.value)} className="text-xl sm:text-2xl font-bold border-b border-emerald-400 outline-none w-full"/>:<h3 className="text-xl sm:text-2xl font-bold text-emerald-900">{ram.name}</h3>}
              </div>
