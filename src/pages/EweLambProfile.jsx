  ...
  return (
    <div className="bg-violet-50 flex flex-col">
      <div className="flex items-center gap-4 px-6 py-4 bg-white shadow-sm">
        ...
        <h2 className="text-2xl font-bold text-violet-900">Ewe Lamb Profile</h2>
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div className="bg-white rounded-2xl shadow p-5">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1"><p className="text-xs font-semibold text-gray-400 uppercase mb-1">Name</p>{isEditing?<input value={edited.name||""} onChange={(e)=>uf("name",e.target.value)} className="text-2xl font-bold border-b border-violet-400 outline-none w-full"/>:<h3 className="text-2xl font-bold text-violet-900">{ewl.name}</h3>}</div>
